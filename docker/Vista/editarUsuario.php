...
if (filter_has_var(INPUT_POST, 'modificarUsuario')) {
    ...
    $contraseñaUsuario = filter_input(INPUT_POST, 'contraseñaEditada');
    $contraseñaUsuario = $contraseñaUsuario ? $contraseñaUsuario : hash("sha512", $usuarioSinEditar[0]['contraseña']);
    ...
    $usuario = new Usuario($dniUsuario, $nombreUsuario, $contraseñaUsuario, $direccionUsuario, $correoUsuario, $fechaNacimientoUsuario, $rolUsuario);
    ...
    <div class="contact-form">
        ...
        <?php foreach ($usuarioSinEditar as $usuario) { ?>
            <form name="sentMessage" id="contactForm" novalidate="novalidate" method="POST">
                ...
                <div class="control-group">
                    <input type="password" class="form-control" name="contraseñaEditada" placeholder="Contraseña" />
                    <p class="help-block text-danger"></p>
                </div>
                <div class="control-group">
                    <input type="password" class="form-control" name="confirmarContraseñaEditada"
